...
scor8894$perio <- ifelse(scor8894$forstet5 > 5, 1, 0)
...
scor95$perio <- ifelse(scor95$FORSTET5 >5 & scor95$indberetningsaar < 1999 | scor95$pato_poch > 5 & scor95$indberetningsaar >= 1999, FLADE, 1, 0)
